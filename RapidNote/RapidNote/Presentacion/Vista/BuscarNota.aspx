<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/Site.Master" AutoEventWireup="true" CodeBehind="BuscarNota.aspx.cs" Inherits="RapidNote.Presentacion.Vista.BuscarNota" %>
        ...
        <fieldset>
            <legend>Buscar Nota</legend>
                <table align="center">                
                    ...
                    <%--<tr>
                        <td>
                            <asp:TextBox ID="TextBoxBuscar" runat="server" Width="350px"></asp:TextBox>
                            <asp:Button ID="ButtonBuscar" runat="server" Text="Bucar" Width="100px" OnClick="ClickBuscarNota"/>
                        </td>
                        </tr>--%>
                        <tr>
                            <td>
                                <asp:GridView ID="GridViewNotas" runat="server" CellPadding="4" ForeColor="#333333"
                                    ...
                                    Style="text-align: center" AllowPaging="True" CssClass="leftCol" ondatabound="Gridview1_DataBound"
